...
new _RevealOnScroll2.default((0, _jquery2.default)('.features__grid-item'), '85%');
new _RevealOnScroll2.default((0, _jquery2.default)('.testimonials__card'), '80%');
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function createWaypoints() {
            ...
            this.itemsToReveal.each(function (el) {
                new Waypoint({
                    element: _this.itemsToReveal[el],
                    handler: function handler() {
                        (0, _jquery2.default)(_this.itemsToReveal[el]).addClass('reveal-item--visible');
                    },
...
var StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createPageSectionWaypoints() {
            ...
            this.pageSections.each(function (el) {
                new Waypoint({
                    element: _this2.pageSections[el],
                    handler: function handler(direction) {
                        if (direction == 'down') {
                            var matchingHeaderLink = _this2.pageSections[el].getAttribute("data-matching-link");
                            _this2.headerLinks.removeClass("current-link");
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function openModal() {
            ...
            //prevent default behaviour when clicking link with # link
            return false;
        }
    }, {
        key: 'closeModal',
